...
class ListSelectionDetailScreen extends StatefulWidget {
  ...
  _ListSelectionDetailScreenState createState() =>
      _ListSelectionDetailScreenState(reading);
}

class _ListSelectionDetailScreenState extends State<ListSelectionDetailScreen> {
  final ListSelection reading;
  _ListSelectionDetailScreenState(this.reading);
  MyAds ads = MyAds();
  ...
  void openBookingDetailsSheet(BuildContext context, ListSelection reading) {
        ...
        ElevatedButton(
          onPressed: () {
            ...
            if (reading.answers != null) {
              openBookingDetailsSheet(context, reading as ListSelection);
            } else {
